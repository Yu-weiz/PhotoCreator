...
namespace Yuweiz.Phone.Media.Imaging.GifLib2
{
    public class GifDecoder
    {
        ...
        protected WriteableBitmap lastImage; // previous frame
        ...
        {
            public GifFrame(WriteableBitmap im, int del)
            {
                image = im;
                delay = del;
            }
            ...
            if (lastDispose > 0)
            {
                ...
                if (lastImage != null)
                {
                    ...
                    if (lastDispose == 2)
                    {
                        ...
                        if (transparency)
                        {
                            c = 0xffffff; 	// assume background is transparent
                        }
                        else
                        {
                            c = lastBgColor;
                        ...
                        this.image.FillRectangle((int)lastRect.Left, (int)lastRect.Top, (int)lastRect.Right, (int)lastRect.Bottom,c);
                    }
                }
            }
