...
namespace WPPhotoEditor
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //初始化友盟
            UmengSDK.UmengAnalytics.Init(AppSession.UmengAppKey);
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
          ...
          //  System.Threading.Thread.CurrentThread.CurrentUICulture = new System.Globalization.CultureInfo("en-us"); 
            ...
            openSettings();
            AppSession.Instance.UpdateAppSession();
        ...
        {
            // 确保所需的应用程序状态在此处保持不变。
            Yuweiz.Phone.IO.IsolatedStorageSettingsDAL.SaveSettingsModel<WPPhotoEditor.Models.SettingsModel>(AppSession.Instance.SettingsModel);
            saveSetting();

            AppSession.Instance.SaveAppSession();
        }
        ...
        {
            Yuweiz.Phone.Diagnostics.Helper helper = new Yuweiz.Phone.Diagnostics.Helper();
            ...
            helper.BugCollect(subject, e.Exception.ToString());
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            if (!hadHandel)
            {
                e.Handled = true;
                hadHandel = true;
                AppSession.Instance.SettingsModel.Errors = e.ExceptionObject.ToString();
                AppSession.Instance.SaveAppSession();
                ...
                string subject = assemblyInfo.Name + "-" + assemblyInfo.Version.ToString() + "：Errors";
                #endregion
                helper.BugCollect(subject, e.ExceptionObject.ToString());
